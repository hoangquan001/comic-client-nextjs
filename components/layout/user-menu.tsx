                ...
                <>
                  ...
                  <div className="p-4 border-t border-neutral-200 dark:border-neutral-700">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <button onClick={() => { setIsOpen(false); window.dispatchEvent(new CustomEvent('open-settings')); }} className="flex flex-col items-center gap-2 p-3 bg-neutral-50 dark:bg-neutral-700 hover:bg-sky-50 dark:hover:bg-sky-900/20 rounded-lg border-none cursor-pointer bg-transparent text-inherit hover:text-sky-600 dark:hover:text-sky-400">
                      ...
                      <Link href="/xep-hang" className="flex flex-col items-center gap-2 p-3 bg-neutral-50 dark:bg-neutral-700 hover:bg-sky-50 dark:hover:bg-sky-900/20 rounded-lg no-underline text-inherit hover:text-sky-600 dark:hover:text-sky-400" onClick={() => setIsOpen(false)}>
                      ...
                      <Link href="/tim-truyen" className="flex flex-col items-center gap-2 p-3 bg-neutral-50 dark:bg-neutral-700 hover:bg-sky-50 dark:hover:bg-sky-900/20 rounded-lg no-underline text-inherit hover:text-sky-600 dark:hover:text-sky-400" onClick={() => setIsOpen(false)}>
                        <svg className="w-6 h-6 text-neutral-500 dark:text-neutral-400" viewBox="0 0 24 24" fill="none" stroke="currentColor">
