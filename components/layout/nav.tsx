...
import {
  openFeedback as openFeedbackEvent,
  openSettings as openSettingsEvent,
...
export function Nav() {
  ...
  const openFeedback = () => {
    ...
    window.dispatchEvent(new CustomEvent(openFeedbackEvent));
  };

  const openSettings = () => {
    setShowSidebar(false);
    window.dispatchEvent(new CustomEvent(openSettingsEvent));
  };
