...
import type { IUser, IServiceResponse } from '@/types';
...
export default function UserInfoPopup({ userId, visible, onClose }: UserInfoPopupProps) {
  ...
  return (
    <div
      ref={modalRef}
      className="fixed max-[376px]:w-[80%] max-sm:w-[300px] bg-white text-black dark:text-light-text dark:bg-neutral-800 shadow-2xl left-1/2 top-1/2 z-50 w-[400px] block rounded-2xl transform -translate-x-1/2 -translate-y-1/2 overflow-hidden border border-neutral-200 dark:border-neutral-700 sm:w-[450px]"
    >
        {isLoading || !userInfo ? (
